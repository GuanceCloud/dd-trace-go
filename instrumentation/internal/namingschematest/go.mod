...
require (
	...
	github.com/GuanceCloud/dd-trace-go/contrib/bradfitz/gomemcache/v2 v2.10.3-ext
	github.com/GuanceCloud/dd-trace-go/contrib/cloud.google.com/go/pubsub.v1/v2 v2.10.3-ext
	github.com/GuanceCloud/dd-trace-go/contrib/confluentinc/confluent-kafka-go/kafka.v2/v2 v2.10.3-ext
	github.com/GuanceCloud/dd-trace-go/contrib/confluentinc/confluent-kafka-go/kafka/v2 v2.10.3-ext
	github.com/GuanceCloud/dd-trace-go/contrib/database/sql/v2 v2.10.3-ext
	github.com/GuanceCloud/dd-trace-go/contrib/dimfeld/httptreemux.v5/v2 v2.10.3-ext
	github.com/GuanceCloud/dd-trace-go/contrib/elastic/go-elasticsearch.v6/v2 v2.10.3-ext
	github.com/GuanceCloud/dd-trace-go/contrib/emicklei/go-restful.v3/v2 v2.10.3-ext
	github.com/GuanceCloud/dd-trace-go/contrib/gin-gonic/gin/v2 v2.10.3-ext
	github.com/GuanceCloud/dd-trace-go/contrib/globalsign/mgo/v2 v2.10.3-ext
	...
	github.com/GuanceCloud/dd-trace-go/contrib/go-pg/pg.v10/v2 v2.10.3-ext
	...
	github.com/GuanceCloud/dd-trace-go/contrib/go.mongodb.org/mongo-driver/v2 v2.10.3-ext
	github.com/GuanceCloud/dd-trace-go/contrib/gocql/gocql/v2 v2.10.3-ext
	github.com/GuanceCloud/dd-trace-go/contrib/gofiber/fiber.v2/v2 v2.10.3-ext
	github.com/GuanceCloud/dd-trace-go/contrib/gomodule/redigo/v2 v2.10.3-ext
	github.com/GuanceCloud/dd-trace-go/contrib/google.golang.org/grpc/v2 v2.10.3-ext
	github.com/GuanceCloud/dd-trace-go/contrib/gorilla/mux/v2 v2.10.3-ext
	github.com/GuanceCloud/dd-trace-go/contrib/gorm.io/gorm.v1/v2 v2.10.3-ext
	github.com/GuanceCloud/dd-trace-go/contrib/graph-gophers/graphql-go/v2 v2.10.3-ext
	github.com/GuanceCloud/dd-trace-go/contrib/graphql-go/graphql/v2 v2.10.3-ext
	github.com/GuanceCloud/dd-trace-go/contrib/hashicorp/consul/v2 v2.10.3-ext
	github.com/GuanceCloud/dd-trace-go/contrib/hashicorp/vault/v2 v2.10.3-ext
	github.com/GuanceCloud/dd-trace-go/contrib/jackc/pgx.v5/v2 v2.10.3-ext
	github.com/GuanceCloud/dd-trace-go/contrib/julienschmidt/httprouter/v2 v2.10.3-ext
	github.com/GuanceCloud/dd-trace-go/contrib/labstack/echo.v4/v2 v2.10.3-ext
	github.com/GuanceCloud/dd-trace-go/contrib/net/http/v2 v2.10.3-ext
	github.com/GuanceCloud/dd-trace-go/contrib/olivere/elastic.v5/v2 v2.10.3-ext
	github.com/GuanceCloud/dd-trace-go/contrib/redis/go-redis.v9/v2 v2.10.3-ext
	github.com/GuanceCloud/dd-trace-go/contrib/redis/rueidis/v2 v2.10.3-ext
	github.com/GuanceCloud/dd-trace-go/contrib/segmentio/kafka-go/v2 v2.10.3-ext
	github.com/GuanceCloud/dd-trace-go/contrib/syndtr/goleveldb/v2 v2.10.3-ext
	github.com/GuanceCloud/dd-trace-go/contrib/tidwall/buntdb/v2 v2.10.3-ext
	github.com/GuanceCloud/dd-trace-go/contrib/twitchtv/twirp/v2 v2.10.3-ext
	github.com/GuanceCloud/dd-trace-go/contrib/uptrace/bun/v2 v2.10.3-ext
	github.com/GuanceCloud/dd-trace-go/contrib/urfave/negroni/v2 v2.10.3-ext
	...
	github.com/GuanceCloud/dd-trace-go/instrumentation/testutils/grpc/v2 v2.10.3-ext
